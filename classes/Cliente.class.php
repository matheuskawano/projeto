<?php
    ...
    class Cliente{
        ...
        public function querySelecionaBusca($dado)
        {
            try{                
                $sql = $this->con->conectar()->prepare("SELECT cliente_id, nome, cpf, dt_nasc, email, cep, logradouro, numero, bairro, complemento, cidade FROM clientes WHERE cpf ILIKE '%{$dado}%' OR nome ILIKE '%{$dado}%' ;");                
